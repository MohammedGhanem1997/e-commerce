...
class AdminProductsController extends Controller
{
    ...
    public function list(): View
    {
        ...
        return view('admin.admin.pages.product.index', ['products' => $products, 'categories' => $categories]);
    }
    ...
    public function categoryFilter(Request $request, ?int $category_id): View|string
    {
        $products = $category_id ?
            Product::where('catalog_id', $category_id)->get() :
            Product::all();

        if ($request->ajax()) {
            return view('admin.admin.pages.product.products-load', compact('products'))->render();
        }
    ...
    public function showEditForm(int $id = null): View|RedirectResponse
    {
        ...
        return view('admin.admin.pages.product.create', ['product' => $product, 'brands' => $brands, 'categories' => $categories]);
    }
...
//        $product->discount = $request->discount;
        ...
        //todo image resize
        $product->save();
        $product->catalogs()->attach($request->categories);

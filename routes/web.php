...
Route::prefix('shop')->group( function() {
    ...
    Route::get('brand/{name}', 'BrandController@show')->name('brand.show');
});
...
Route::prefix('admin')->group( function() {
    ...
    Route::get('/brands', 'AdminBrandController@list')->name('admin.brands');
    Route::delete('/brands/{id}', 'AdminBrandController@delete');
    Route::get('/add-brand', 'AdminBrandController@showEditForm')->name('add-brand');
    Route::get('/edit-brand/{id}', 'AdminBrandController@showEditForm');
    Route::post('/brands', 'AdminBrandController@update');


    //Admin brand management
    Route::get('/sliders', 'AdminSliderController@list')->name('admin.sliders');
    Route::delete('/sliders/{id}', 'AdminSliderController@delete');
    Route::get('/add-slider', 'AdminSliderController@showEditForm')->name('add-slider');
    Route::get('/edit-slider/{id}', 'AdminSliderController@showEditForm');
    Route::post('/sliders', 'AdminSliderController@update');
...
Route::get('/product', function () {
    ...
    return \App\Product::find(2)->relatedProducts;
});